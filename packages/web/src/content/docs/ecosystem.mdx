...
| [opencode-supermemory](https://github.com/supermemoryai/opencode-supermemory)                             | Persistent memory across sessions using Supermemory. [Learn more](/docs/memory#extend-with-plugins) |
